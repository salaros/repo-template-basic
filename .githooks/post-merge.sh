...
# Check if the skill lock file has changed and restore the skills it records
if file_changed 'skills-lock\.json'; then
    echo "skills-lock.json changed. Running scripts/skills-install.sh..."
