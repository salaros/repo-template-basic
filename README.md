...
| `MEMORY.md` | The project facts (name, purpose, requirements location, stack, and the Jira project when there is one), one per line. Written by the `project-init` skill; absent until it runs. |
